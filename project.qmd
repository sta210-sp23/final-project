...
Both of these sources allow for easy copy + pasting of CSV files with the annual stats for each team and their tournament performance.
...
**EXPLORATORY DATA ANALYSIS - Wins by Conference in March Madness**
...
ggplot(cbb, aes(x = Conference, y = mm_WINS, fill = Conference)) +
  ...
  labs(
    x = "Conference",
    y = "Wins",
    title = "Wins by Conference"
  )

```

**EXPLORATORY DATA ANALYSIS - Averages for stats---by round, Averages for winner stats**
