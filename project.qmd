...
```{r EDA-conferences, echo = FALSE, fig.width = 13}
...
```{r ordinal-reg, message = FALSE, echo = FALSE}
...
```{r predictions, message = FALSE, echo = FALSE}
...
![](NCAA-Tournament-Printable-Bracket-2023.pdf){fig-align="center" width="1833"}

The ordinal model was able to predict 23/32 and 12/16 of the teams to make it on to the Round of 32 and Sweet Sixteen, respectively. For comparison, this bracket predicted around the average score of our brackets, which were likely better than average since we grew up UConn fans and often had them going far. The successes in the earlier rounds fell off onto later rounds, of course due to chance, but possibly also due to quite low levels of data for prediction of success.
...
Some of the other interesting surprises that our model did not get right include:

-   16-seed Fairleigh Dickinson's upset of 1-seed Purdue: Our model had Purdue reaching the Sweet Sixteen. Our model also stated that FDU had the lowest probability of winning any game (ranked the worst team in the tournament).

-   15-seed Princeton's upset of 2-seed Arizona: Princeton was ranked as the 55th best team in the tournament. Arizona was predicted to reach the Sweet Sixteen.

-   4-seed Tennessee were predicted to play in the National Championship game, but they lost in the Sweet Sixteen as a part of FAU's Cinderella story. Per our model, FAU was ranked as the 25th best team in the tournament.
